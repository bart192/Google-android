...
public class StudentActivity extends AppCompatActivity {
    ...
    private EditText etName, etStudentNumber, etMail, etKlas;
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etName.getText().toString().trim().length() > 0|| etStudentNumber.getText().toString().trim().length() > 0 || etMail.getText().toString().trim().length() > 0 || etKlas.getText().toString().trim().length() > 0){
                    save(etName.getText().toString(), etStudentNumber.getText().toString(), etMail.getText().toString(),imgSpinner.getSelectedItem().toString().toLowerCase().replace(" ", "") ,  etKlas.getText().toString());
                    sortRecyclerViewOnFirstName();
                    d.dismiss();
                }
                else {
    ...
    private void save(String name, String studentnummer,String email, String image, String klas) {
        dbAdapter db = new dbAdapter(this);
        db.openDB();
        long result = db.add(name, studentnummer, email, image, klas);
        if (result > 0) {
            etName.setText("");
    ...
    private void retrieve() {
        ...
        while (c.moveToNext()) {
            ...
            dbProperties f = new dbProperties(id, name, studentnumber, email, image,  klas);
            properties.add(f);
        }
    ...
    public void addAllStudents() {
        ...
        db.add("Bart van Es", "0264650", "bvanes01@student.rocvantwente.nl", "bartvanes", "I4AO1");
        db.add("Tim Bruntink", "0267599", "tbruntink01@student.rocvantwente.nl", "timbruntink", "I4AO1");
        db.add("Kelvin Cornelissens", "0267772", "kcornelissens01@student.rocvantwente.nl", "kelvincornelissens", "I4AO1");
        db.add("Martijn Dekker", "0256907", "mdekker04@student.rocvantwente.nl", "martijndekker", "I4AO1");
        db.add("Dylan Doornbos", "0265788", "ddoornbos01@student.rocvantwente.nl", "dylandoornbos", "I4AO1");
        db.add("Loek Gosen", "0267853", "lgosen01@student.rocvantwente.nl", "loekgosen", "I4AO1");
        db.add("Bas Grave", "0267617", "bgrave01@student.rocvantwente.nl", "basgrave", "I4AO1");
        db.add("Dylan Hofstra", "0263413", "dhoftsra02@student.rocvantwente.nl", "dylanhofstra", "I4AO1");
        db.add("Jordy Mengerink", "0265597", "jmengerink03@student.rocvantwente.nl", "jordymengerink", "I4AO1");
        db.add("James Morsink", "0267422", "jmorsink09@student.rocvantwente.nl", "jamesmorsink", "I4AO1");
        db.add("Robin Tatlici", "0187199", "rtatlici01@student.rocvantwente.nl", "robintatlici", "I4AO1");
        db.add("Laurens Tel", "0179028", "ltel01@student.rocvantwente.nl", "laurenstel", "I4AO1");
        db.add("Carlo Verver", "0269264", "cverver01@student.rocvantwente.nl", "carloverver", "I4AO1");
        db.add("Firdhan Yahya", "0267433", "fyahya01@student.rocvantwente.nl", "firdhanyahya", "I4AO1");
        db.add("Jake Zweers", "0257956", "jzweers05@student.rocvantwente.nl", "jakezweers", "I4AO1");
